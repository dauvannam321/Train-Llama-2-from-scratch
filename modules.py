...
class ModelArgs:
    dim: int = 4096
    n_layers: int = 32 # Nx layers of EncoderBlock
...
class SelfAttention(nn.Module):
    ...
    def __init__(self, args: ModelArgs):
        ...
        # Indicates how many times the heads of Keys and Values should be 
        # repeated to match the head of the Queries
    ...
    def forward(self, x: torch.Tensor, start_pos: int, freqs_complex: torch.Tensor):
        ...
        # Apply Wq, Wk, Wv matrices to queries, keys and values
...
class Transformer(nn.Module):
    ...
    def forward(self, tokens: torch.Tensor, start_pos: Optional[int] = 0):
        # (B, Seq_Len)
